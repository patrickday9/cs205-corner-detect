...
if __name__ == '__main__':
	...
	if len(sys.argv) > 2: 
		...
		print 'Default number of runs:', num_runs


	Harris_Matrix, serial_points, parallel_points, output_times_openCL, output_times_serial = harris_get_corners(num_runs, image)
